...
temp_frame_formats : List[TempFrameFormat] = [ 'bmp', 'jpg', 'png', 'tif', 'exr' ]
output_audio_encoders : List[OutputAudioEncoder] = [ 'aac', 'libmp3lame', 'libopus', 'libvorbis' ]
output_video_encoders : List[OutputVideoEncoder] = [ 'prores_ks', 'libx264', 'libx265', 'libvpx-vp9', 'h264_nvenc', 'hevc_nvenc', 'h264_amf', 'hevc_amf', 'h264_videotoolbox', 'hevc_videotoolbox' ]
...
face_mask_padding_range : Sequence[int] = create_int_range(-100, 100, 1)
